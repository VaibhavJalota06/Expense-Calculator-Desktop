@echo off
title Expense OS - Automatic GitHub Sync and Executable Builder
cd /d "%~dp0"
set PATH=C:\Program Files\nodejs;C:\Program Files\Git\cmd;%PATH%

echo ========================================================
echo   Expense OS - Automatic GitHub Sync and Executable Builder
echo ========================================================
echo.
...
"C:\Program Files\Git\cmd\git.exe" commit -m "Auto-update Expense OS code and build"

echo.
echo [2/3] Syncing with GitHub (master, main, and gh-pages)...
...
echo.
echo ========================================================
echo   SUCCESS! GitHub code, Live Web App, and .exe are updated!
echo ========================================================
echo.
